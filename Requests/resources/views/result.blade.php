                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                         ...
                                         <div class=" text-xl font-bold text-red-600/100"><p><?php echo $requete ?></p></div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                <div class="text-xl font-bold text-blue-600/100  overflow-x-scroll  ">
                                {{$value}}
                                </div>
                            </div>
                        </div>
